        ...
        <footer className="footer bg-neutral text-neutral-content p-10">
            <aside>
                ...
                <p>
                    AI Text Generator
                    <br />
                    Empowering creativity with AI since 2024
                </p>
            </aside>
            <nav>
            ...
            <nav>
                ...
                <Link href="/en" className="link link-hover">English</Link>
                <Link href="/zh" className="link link-hover">中文</Link>
                <Link href="/fr" className="link link-hover">Français</Link>
            </nav>
            <nav>
